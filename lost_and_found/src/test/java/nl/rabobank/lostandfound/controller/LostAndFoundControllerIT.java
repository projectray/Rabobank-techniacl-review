...
class LostAndFoundControllerIT {
  ...
  @Test
  void uploadLostItemsFileTest() throws Exception {
    ...
    MvcResult result = mockMvc.perform(multipart("/api/admin/upload-items").file(mockFile)
    ...
    assertTrue(response.contains("Headphones"));
  }
